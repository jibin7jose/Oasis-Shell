...
# We already tried this one in multi_replace, let's verify if it needs python too
...
# Wait, complete_golem_task signature might not have db state. I should check.
